...
![](screen/1_Node_quick.png)

После отработки скрипта части 2

![](screen/2.1_after_script_2.png)

![](screen/2.2_after_script_2.png)



До запуска команды **stress -c 2 -i 1 -m 1 --vm-bytes 32M -t 10s** 

![](screen/3.1_before_stress.png)

![](screen/3.2_before_stress.png)


После запуска **stress -c 2 -i 1 -m 1 --vm-bytes 32M -t 10s** 

![](screen/3.1_stress_32M.png)

![](screen/3.2_stress_32M.png)

После запуска команды **stress -c 2 -i 1 -m 1 --vm-bytes 200M -t 30s** 

![](screen/4.1_stress_200M.png)

![](screen/4.2_stress_200M.png)
